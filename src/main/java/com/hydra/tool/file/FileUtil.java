...
public class FileUtil {
    ...
    public static File[] ls(String path) {
        ...
        throw new RuntimeException(StrUtil.format("Path [{}] is not directory!", path));
    }
    ...
    public static List<String> listFileNames(String path) {
        ...
        try {
            ...
            throw new RuntimeException(StrUtil.format("Can not read file path of [{}]", path), e);
        }
        return paths;
    }
